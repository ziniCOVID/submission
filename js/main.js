...
const clusterConfigs = {
    'political-chain': {
        ...
        description: 'Shows the relationship pathway from Prime Minister Jacinda Ardern through the Bill & Melinda Gates Foundation and Melinda Gates to the Pfizer-BioNTech vaccine.',
    ...
    'research-chain': {
        ...
        description: 'Illustrates the connection from Dr. Siouxsie Wiles through research organizations to the vaccine, highlighting the research influence pathway.',
        path: []
    },
    'advisory-chain': {
        ...
        description: 'Demonstrates the pathway from Dr. Helen Petoussis-Harris through advisory networks to the vaccine, showing key advisory relationships.',
        path: []
    }
};
...
function updateDetailsPanel(itemData, itemType) {
    ...
    if (itemData.EvidenceData && Array.isArray(itemData.EvidenceData) && itemData.EvidenceData.length > 0) {
        ...
        evidenceListEl.innerHTML = '<i>No evidence linked.</i>';
    }
...
function displayClusterDetails(clusterId) {
    ...
    overviewDiv.innerHTML = `
        <p style="color: #666; margin-bottom: 10px;">This cluster highlights key relationships in the network. Click "Start Exploring" to walk through each connection step by step.</p>
    `;
